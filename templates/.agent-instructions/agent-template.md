# [Backend/Frontend] Agent Instructions

<!-- WHY THIS FILE EXISTS:
Each agent needs a complete briefing BEFORE it writes any code. Without this, agents
make assumptions about scope, conventions, and priorities that conflict with the project's
actual constraints. This file is the agent's "job description" -- read it first, then
start working. -->
...
If you need a change in another agent's territory, document it in your state file under
"Cross-Agent Requests" and notify the team lead.
...
- If an endpoint is underspecified, document the ambiguity in your state file -- do not guess.
- If you discover the spec needs a change, record it under "Contract Deviations" in your state file. Do not modify the spec.
